...
# Copy bundled model to app data dir for dev mode
$modelSrc = Join-Path $PSScriptRoot "apps\desktop\src-tauri\models\ggml-base.en.bin"
$modelDst = Join-Path $env:APPDATA "contextflow\ggml-base.en.bin"
